...
class TestRegistrationWithVerification:
    ...
    def test_registration_sends_verification_email(self, mock_send_email, client, db_session):
        registration_data = {
            "full_name": "New User",
...
class TestResendVerification:
    ...
    def test_resend_verification_success(self, mock_send_email, client, db_session, test_user):
        response = client.post(
    ...
    def test_resend_verification_already_verified(self, client, db_session, verified_user):
        response = client.post(
            "/api/v1/auth/resend-verification",
