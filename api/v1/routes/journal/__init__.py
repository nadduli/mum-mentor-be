...
from .get_all_entries import router as get_all_entries_router
from .delete_journal_entry import router as delete_journal_router
...
journal_entry_router.include_router(get_all_entries_router)
journal_entry_router.include_router(delete_journal_router)
...
router.include_router(delete_journal_router)
