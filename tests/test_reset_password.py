...
class TestResetPasswordSuccess:
    ...
    def test_successful_password_reset_via_endpoint(self, client, test_user, monkeypatch):
        """Test successful password reset through API endpoint"""
        # Mock user_id to return our test user's ID
        ...
        monkeypatch.setattr(reset_password_module, "reset_password", mock_reset_password)
        
        response = client.patch("/api/v1/reset-password", json={
            "old_password": "OldPassword123",
...
class TestResetPasswordValidationErrors:
    ...
    def test_old_password_too_short(self):
        ...
        with pytest.raises(ValueError, match="Old password must be at least 8 characters long"):
            ResetPassword(
                old_password="Short1",
                new_password="NewPassword123",
                confirm_password="NewPassword123"
    ...
    def test_confirm_password_too_short(self):
        ...
        with pytest.raises(ValueError, match="Confirm password must be at least 8 characters long"):
            ResetPassword(
                old_password="OldPassword123",
                new_password="NewPassword123",
                confirm_password="Short1"
...
class TestResetPasswordServerErrors:
    ...
    def test_verify_password_failure(self, db_session, test_user, monkeypatch):
        ...
        monkeypatch.setattr(reset_password_module, "verify_password", mock_verify_password)
